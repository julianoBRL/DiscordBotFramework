...
@SupportedAnnotationTypes({"io.github.julianobrl.discordbots.annotations.commands.PrefixCommand"})
@SupportedSourceVersion(SourceVersion.RELEASE_17)
public class PrefixCommandProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(PrefixCommand.class)) {
